...
public class MDSSearchServiceSolrImplTest {
    ...
    public void testQuery() throws Exception {
        ...
        SolrQuery query = MDSSearchServiceSolrImpl.constructSolrQuery(from, to, set, offset, length,null);
        String[] filtersActual = query.getFilterQueries();
        String[] filtersExpected = { "updated:[" + fromStr + " TO " + toStr + "]" };
    ...
    private SolrQuery testSet(String set, String... filtersExpected) throws Exception {
        SolrQuery query = MDSSearchServiceSolrImpl.constructSolrQuery(from, to, set, 0, 50,null);
        String[] filtersActual = query.getFilterQueries();
        
        String[] filterAdditional = { "updated:[" + fromStr + " TO " + toStr + "]" };
