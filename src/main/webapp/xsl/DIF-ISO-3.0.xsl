						...
						<xsl:if test=".='DIF AUTHOR'">
							<gmd:contact>
								<gmd:CI_ResponsibleParty>
									<gmd:individualName>
										<gco:CharacterString>
											<xsl:value-of select="../dif:Last_Name"></xsl:value-of>, <xsl:value-of select="../dif:First_Name"></xsl:value-of> <xsl:value-of select="../dif:Middle_Name"></xsl:value-of>
										</gco:CharacterString>
									</gmd:individualName>
                  ...
                  <xsl:if test=".='INVESTIGATOR'">								
                    <gmd:citedResponsibleParty>
                      <gmd:CI_ResponsibleParty>
                        <gmd:individualName>
                          <gco:CharacterString>
                            <xsl:value-of select="../dif:Last_Name"/>, <xsl:value-of select="../dif:First_Name"/> <xsl:value-of select="../dif:Middle_Name"/>
                          </gco:CharacterString>
                        </gmd:individualName>
